...
class Listrik:
    def __init__(self, tabelPembangkitListrik, periode, minListrik, maxMT = 2, SelectionMethod =1):
...
test1 = Listrik(tablePembangkitListrik, 6, 110, 2, 1) #UTAMA
...
def run(tablePembangkitListrikk, periode = 6, minListrik = 110):
    ...
    tablePembangkitListrik = copy.deepcopy(tablePembangkitListrikk)
    print(tablePembangkitListrik)
    print(periode)
    print(minListrik)
    test1 = Listrik(tablePembangkitListrik, periode, minListrik, maxMT = 2, SelectionMethod=1)
